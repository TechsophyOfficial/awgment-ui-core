...
The following are the features of Core Module.
* Provides landing page for AUGMNT with header,footer and sidenav
* ***Header*** - enables users to view brand image, view preferences (e.g., theme), option to logout, help center etc
* ***Footer*** - enables users to view privacy policy brand name etc
